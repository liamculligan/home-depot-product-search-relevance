...
#Train multiple gradient boosted decision trees on feature_engineering_set_2 using a custom cross-validation scheme and bag the results
...
#Load required data
load("feature_engineering_set_2.RData")
